...
(function(){
  ...
  function close(){ overlay.classList.remove('open'); panel.classList.remove('open'); document.body.style.overflow=''; stack=[]; updateBack(); if(window.__CLEARSEL) window.__CLEARSEL(); }
  ...
  document.addEventListener('click', function(e){
    if(window.__LIVE_ON && e.target.closest('.kcard[data-live]')) return; // live mode owns the click
